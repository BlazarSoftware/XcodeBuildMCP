...
This document lists MCP tool names as exposed to MCP clients. XcodeBuildMCP provides 80 canonical tools organized into 15 workflow groups for comprehensive Apple development workflows.

## Workflow Groups

### Build Utilities (`utilities`)
**Purpose**: Utility tools for cleaning build products and managing build artifacts. (2 tools)

- `clean` - Defined in iOS Device Development workflow.
- `set_plist_value` - Set a key path value in a plist file.
...
*This documentation is automatically generated by `scripts/update-tools-docs.ts` from the tools manifest. Last updated: 2026-02-26T06:33:47.966Z UTC*
